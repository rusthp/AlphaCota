...
def generate_decision_report(
    ...
    for ticker, metadas_pos in posicoes_metricas.items():
        ...
        ativos_atuais_para_rebalance.append({"ticker": ticker, "valor": v_atual})
    ...
    try:
        rebalanceamento_res = calculate_rebalance_suggestion(
            ativos_atuais=ativos_atuais_para_rebalance, alocacao_alvo=alocacao_alvo, aporte_mensal=aporte_mensal
        )
    ...
    return {
        ...
        "renda_passiva": {"renda_total": renda_total, "yield_percentual": yield_percentual},
        "fogo_financeiro": {"patrimonio_necessario": patrimonio_necessario, "anos_estimados": anos_estimados},
        "rebalanceamento": {"sugestao": sugestao},
    }
