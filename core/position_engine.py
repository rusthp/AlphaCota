...
def calculate_position_metrics(
    operacoes: list[dict[str, Union[str, float, int]]], precos_atuais: dict[str, float]
    ...
    for op in operacoes:
        ...
        if tipo == "compra":
            ...
            if qtd > pos["quantidade_total"]:
                raise ValueError(
                    f"Venda a descoberto não permitida para o ativo {ticker}. Tentou vender {qtd} possuindo {pos['quantidade_total']}."
                )
