...
class TestCalculateQualityScore:
    ...
    def test_excellent_company(self):
        data = {
            "pl": 5.0, "pvp": 0.5, "roe": 30.0, "roa": 20.0,
            "revenue_growth": 20.0, "earnings_growth": 25.0,
            "debt_to_equity": 0.0, "current_ratio": 3.0,
        }
        score = calculate_quality_score(data)
        assert score > 80.0
    ...
    def test_poor_company(self):
        data = {
            "pl": 30.0, "pvp": 5.0, "roe": 5.0, "roa": 2.0,
            "revenue_growth": 0.0, "earnings_growth": 0.0,
            "debt_to_equity": 2.0, "current_ratio": 1.0,
        }
        score = calculate_quality_score(data)
        assert score < 20.0
...
class TestCalculateAltmanZ:
    def test_healthy_company(self):
        data = {
            ...
            "working_capital": 200, "retained_earnings": 400,
            "ebit": 150, "market_value_equity": 800, "revenue": 1200,
        }
...
class TestEvaluateCompany:
    def test_returns_all_fields(self):
        data = {"pl": 10.0, "pvp": 1.0, "roe": 20.0, "roa": 10.0,
                "total_assets": 1000, "total_liabilities": 300}
