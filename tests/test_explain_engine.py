...
def _allocations():
    return [
        {"ticker": "HGLG11", "classe": "FII", "final_score": 85.0,
         "momentum_score": 60.0, "altman_z_score": 3.5, "peso_alvo": 0.40},
        {"ticker": "XPML11", "classe": "FII", "final_score": 70.0,
         "momentum_score": 25.0, "altman_z_score": 2.5, "peso_alvo": 0.30},
    ]
...
class TestGeneratePortfolioExplanation:
    def test_returns_all_sections(self):
        result = generate_portfolio_explanation(
            _allocations(), "moderado", 150000.0, 8.5,
            {"FII": 0.70, "ETF": 0.30},
        )
    ...
    def test_fire_red_status_string_input(self):
        result = generate_portfolio_explanation(
            _allocations(), "moderado", 150000.0, "inalcançável",
            {"FII": 0.70},
        )
