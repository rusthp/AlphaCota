...
class TestFundamentalsScraper:
    ...
    def test_save_manual_fundamentals(self, temp_db):
        ...
        save_manual_fundamentals("TESTFII11", {
            "dividend_yield": 0.12,
            "pvp": 0.95,
            "debt_ratio": 0.2,
        }, db_path=temp_db)
...
class TestPipelineIntegration:
    ...
    def mock_assets(self):
        ...
        return [
            {
                "ticker": "MXRF11", "classe": "FII",
                "preco_atual": 10.05, "dividend_yield": 0.10,
                "dividend_consistency": 9.0, "pvp": 0.95,
                "debt_ratio": 0.2, "vacancy_rate": 0.0,
                "revenue_growth_12m": 0.05, "earnings_growth_12m": 0.03,
                "working_capital": 1000, "total_assets": 5000,
                "retained_earnings": 800, "ebit": 400,
                "market_value_equity": 3000, "total_liabilities": 1500, "revenue": 1200,
            },
            {
                "ticker": "HGLG11", "classe": "FII",
                "preco_atual": 155.0, "dividend_yield": 0.08,
                "dividend_consistency": 8.5, "pvp": 1.05,
                "debt_ratio": 0.25, "vacancy_rate": 0.03,
                "revenue_growth_12m": 0.08, "earnings_growth_12m": 0.06,
                "working_capital": 2000, "total_assets": 10000,
                "retained_earnings": 1500, "ebit": 800,
                "market_value_equity": 7000, "total_liabilities": 3000, "revenue": 2500,
            },
            {
                "ticker": "XPML11", "classe": "FII",
                "preco_atual": 90.0, "dividend_yield": 0.09,
                "dividend_consistency": 7.5, "pvp": 1.10,
                "debt_ratio": 0.35, "vacancy_rate": 0.08,
                "revenue_growth_12m": 0.04, "earnings_growth_12m": 0.02,
                "working_capital": 1500, "total_assets": 8000,
                "retained_earnings": 1200, "ebit": 600,
                "market_value_equity": 5000, "total_liabilities": 2500, "revenue": 1800,
            },
            {
                "ticker": "KNCR11", "classe": "FII",
                "preco_atual": 97.80, "dividend_yield": 0.11,
                "dividend_consistency": 9.5, "pvp": 0.98,
                "debt_ratio": 0.15, "vacancy_rate": 0.0,
                "revenue_growth_12m": 0.06, "earnings_growth_12m": 0.05,
                "working_capital": 3000, "total_assets": 15000,
                "retained_earnings": 2500, "ebit": 1200,
                "market_value_equity": 10000, "total_liabilities": 4000, "revenue": 3500,
            },
        ]
...
class TestDataBridgeUniverse:
    ...
    def test_sector_map_values_are_valid(self):
        from data.data_bridge import SECTOR_MAP
        valid_sectors = {
            "Papel (CRI)", "Logística", "Shopping", "Lajes Corp.",
            "Fundo de Fundos", "Híbrido", "Saúde", "Agro",
            "Residencial", "Educacional", "Hotel", "Outros",
        }
