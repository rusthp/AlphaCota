...
Generated at: 2026-03-15T21:54:17.613Z
...
- **Core**: Agent Automation, DAG Workflow, Documentation Rules, Quality Enforcement, Rulebook Task Management, accessibility, api-design, architect, build-fix, db-design, debug, deploy, docs, migrate, perf, refactor, research, review, security-audit, Agents Lean, Agents Override, Agent Automation, Dag, Decisions, Documentation Rules, Knowledge, Multi Agent, Plans, Quality Enforcement, Ralph, Rulebook, Workspace
...
| Core | Agents Lean | Generated by @hivehub/rulebook (lean mode). Spec files are in `/.rulebook/specs/`. |
